 ...
 * backup_send_failed
 *
 * This event is to be triggered whenever backup send failed.
 *
 *
 * @package    tool_coursestore
 * @author     Dmitrii Metelkin <dmitriim@catalyst-au.net>
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class backup_send_failed extends \core\event\base {
    protected function init() {
        $this->data['crud'] = 'c'; // Note: c(reate), r(ead), u(pdate), d(elete).
        $this->data['edulevel'] = self::LEVEL_OTHER;
    }

    public static function get_name() {
        return get_string('eventbackupsendfailed', 'tool_coursestore');
    }
